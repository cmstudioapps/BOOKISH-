export default function handler(req, res) {
  ...
  if (req.method === "POST") {
    ...
    const meu_prompt = `Responda apenas com "true" ou "false" e nada mais. True apenas se o texto estiver sem sentido, for composto por palavras aleatórias, repetir as mesmas palavras exatamente a cada 2-3 palavras (sem variação), ou estiver vazio ou tentativa de xss. Caso contrário, responda false. Texto: "${textoAvaliar}"`;
